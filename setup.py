#!/usr/bin/env python
# This file is part account_payment_sepa_es module for Tryton.
...
dependency_links = [
    ('hg+https://bitbucket.org/trytonspain/'
        'trytond-account_payment_es@%(branch)s'
        '#egg=trytonspain-account_payment_es-%(series)s' % {
            'branch': branch,
            'series': series,
            }),
    ('hg+https://bitbucket.org/trytonspain/'
...
setup(name='%s_%s' % (PREFIX, MODULE),
    version=version,
    description='Tryton account_payment_sepa_es Module',
